...
public interface IArrowContainer2 {
	 ...
	 * 
	 * @param container
	 *            {@link ItemStack} representing this item
	 ...
	 * 
	 * @param container
	 *            The {@link ItemStack} representing this item
	 * @param slot
	 *            the slot index
	 ...
	 *            the slot index
	 * @param stack
	 *            {@link ItemStack} representing the new stack
	 */
	 ...
	 *            The {@link ItemStack} representing this item
	 * @param bow
	 *            The bow trying to use this container
	 * @param player
	 *            The {@link EntityPlayer} using the bow
	 ...
	 *            The {@link ItemStack} representing this item
	 * @param charge
	 *            Amount of charge in the bow, ranging from 0.2F to 2.0F
	 * @param player
	 *            The {@link EntityPlayer} using the bow
	 * @param world
	 ...
	 * 
	 * @param arrowEvent
	 *            Used to decide bow damage, bow sound and arrow enchantment
	 */
	 ...
	 *            The {@link ItemStack} representing this item
	 * @param arrowStack
	 *            The {@link ItemStack} representing other items
	 ...
	 *            The {@link ItemStack} representing this item
	 * @param newStack
	 *            Another valid item on the crafting bench
