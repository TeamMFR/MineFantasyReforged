...
public class CarpentersBench {
	...
	@ZenMethod
	public static void addShapedRecipe(@NotNull IItemStack output, String skill, String research, String sound, double exp, String tool, int hammer, int anvil, int time, IIngredient[][] ingreds){
		MineTweakerAPI.apply(new CarpentersAction(output,Skills.getFromString(skill).getSkill(), research, sound, (float)exp, tool, hammer, anvil, time, ingreds));
	}
	
	@ZenMethod
	public static void addShapelessRecipe(@NotNull IItemStack output, String skill, String research, String sound, double exp, String tool, int hammer, int anvil, int time, IIngredient[] ingreds){
		MineTweakerAPI.apply(new CarpentersAction(output,Skills.getFromString(skill).getSkill(), research, sound, (float)exp, tool, hammer, anvil, time, ingreds));
	}
	...
	public static class CarpentersAction implements IUndoableAction{
		...
		public CarpentersAction(IItemStack out, Skill s, String research, String sound, float exp, String tool, int hammer, int anvil, int time, IIngredient[][] ingreds) {
			this.out = out;
			this.s = s;
