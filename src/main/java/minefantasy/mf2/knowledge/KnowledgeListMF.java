...
public class KnowledgeListMF
{
    ...
    public static void init()
	{
        ...
        smeltIron = (new InformationBase("smeltIron",  			    1, 4,  1, Items.iron_ingot, null)).registerStat().setPage(artisanry).addSkill(SkillList.artisanry, 10).setDescriptValues(getMetalTier("iron"));
        ...
        smeltAdamant = (new InformationBase("smeltAdamantium", 		3, 12, 3, ComponentListMF.ingots[13], null)).registerStat().setPage(artisanry).addSkill(SkillList.artisanry, 75).setDescriptValues(getMetalTier("adamantium"));
        ...
        firebomb = (new InformationBase("firebomb", 		  		    0, 6, 2, Items.blaze_powder, shrapnel)).registerStat().setPage(engineering).addSkill(SkillList.engineering, 85);
        stickybomb = (new InformationBase("stickybomb", 			   -2, 2, 1, Items.slime_ball, bombs)).registerStat().setPage(engineering).addSkill(SkillList.engineering, 50);
        ...
        //MASTERY
        toughness = (new InformationBase("toughness",	-1, 0,  0, CustomArmourListMF.standard_plate_helmet, (InformationBase)null)).registerStat().setPage(mastery).addSkill(SkillList.combat, 10).setPerk();
        ...
        armourpro = (new InformationBase("armourpro",	 2, -1, 0, Items.diamond_chestplate, fitness)).registerStat().setPage(mastery).addSkill(SkillList.combat, 60).setPerk();
        parrypro = (new InformationBase("parrypro",	 	-2, -1, 0, Items.iron_sword, toughness)).registerStat().setPage(mastery).addSkill(SkillList.combat, 20).setPerk();
        counteratt = (new InformationBase("counteratt",	-1, -2, 0, CustomToolListMF.standard_waraxe, parrypro)).registerStat().setPage(mastery).addSkill(SkillList.combat, 25).setPerk();
        autoparry = (new InformationBase("autoparry",   -3, -2, 0, CustomToolListMF.standard_sword, parrypro)).registerStat().setPage(mastery).addSkill(SkillList.combat, 50).setPerk();
    ...
    public static IRecipe firepitRecipe, cooktopRecipe, carpenterRecipe, waterJugR, milkJugR, plantOilR, sugarRecipe, stickRecipe, dryrocksR, meatpieOut, shepardOut, cheeseOut, berryOut, appleOut, pumpPieOut;
    ...
    public static ICarpenterRecipe nailPlanksR, nailStairR, refinedStairR, strongRackR, bellowsRecipe, bloomeryR, crucibleRecipe, advCrucibleRecipe, trilogyRecipe, chimneyRecipe, wideChimneyRecipe, extractChimneyRecipe;
