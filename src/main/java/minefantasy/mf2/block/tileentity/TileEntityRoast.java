...
public class TileEntityRoast extends TileEntity implements IInventory, IHeatUser
{
	...
	public void updateEntity()
	{
		...
		{
			worldObj.spawnParticle("flame", xCoord+0.2F+(rand.nextFloat()*0.6F), yCoord+0.2F, zCoord+0.2F+(rand.nextFloat()*0.6F)
					,0F, 0F, 0F);
		}
	}
	private int getTemp() 
	...
	public boolean interact(EntityPlayer player)
	{
		...
		if(item == null)
		{
			if(held != null && !(held.getItem() instanceof ItemBlock) && CookRecipe.getResult(held, isOven()) != null)
			{
