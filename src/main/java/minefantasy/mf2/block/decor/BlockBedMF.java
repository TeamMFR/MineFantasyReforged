...
public class BlockBedMF extends BlockDirectional
{
     ...
     */
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer user, int meta, float fx, float fy, float fz)
    {
        if (world.isRemote)
        {
            return true;
    ...
    public IIcon getIcon(int side, int meta)
    {
        ...
        else
        {
            ...
            return (i1 != 1 || l != 2) && (i1 != 0 || l != 3) ? (l != 5 && l != 4 ? this.topTex[i1] : this.sideTex[i1]) : this.endTex[i1];
        }
    }
    ...
    {
        this.topTex = new IIcon[] {register.registerIcon(this.getTextureName() + "_feet_top"), register.registerIcon(this.getTextureName() + "_head_top")};
        this.endTex = new IIcon[] {register.registerIcon(this.getTextureName() + "_feet_end"), register.registerIcon(this.getTextureName() + "_head_end")};
        this.sideTex = new IIcon[] {register.registerIcon(this.getTextureName() + "_feet_side"), register.registerIcon(this.getTextureName() + "_head_side")};
