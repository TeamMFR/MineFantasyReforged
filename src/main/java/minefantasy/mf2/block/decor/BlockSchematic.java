...
public class BlockSchematic extends Block 
{
	...
	public static boolean useSchematic(ItemStack item, World world, EntityPlayer user, MovingObjectPosition movingobjectposition) 
	{
	...
	public static boolean placeSchematic(int meta, EntityPlayer user, ItemStack item, World world, int x, int y, int z)
	{
