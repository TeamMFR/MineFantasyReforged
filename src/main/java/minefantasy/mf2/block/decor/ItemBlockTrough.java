...
public class ItemBlockTrough extends ItemBlock implements IStorageBlock
{
    ...
    public void addInformation(ItemStack item, EntityPlayer user, List list, boolean info)
	{
		...
		if(material != null)
		{
			list.add(StatCollector.translateToLocalFormatted("attribute.fill.capacity.name", TileEntityTrough.getCapacity(material.tier) * TileEntityTrough.capacityScale));
		}
	}
