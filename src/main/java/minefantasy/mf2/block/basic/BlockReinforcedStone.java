...
public class BlockReinforcedStone extends BlockMeta 
{
	...
	{
		if(side < 2 && meta < names.length && (this.names[meta].startsWith("dshall") || this.names[meta].equalsIgnoreCase("engraved")))
		{
			return icons[0];
		}
	...
	{
		if(meta < names.length && (this.names[meta].startsWith("dshall") || this.names[meta].equalsIgnoreCase("engraved")))
		{
