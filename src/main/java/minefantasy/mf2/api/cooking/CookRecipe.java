...
public class CookRecipe 
{
	...
	public static CookRecipe addRecipe(ItemStack in, ItemStack out, int min, int max, int time, boolean bake, boolean canBurn)
	{
	 ...
	 */
	public static CookRecipe addRecipe(ItemStack in, ItemStack out, ItemStack burnt, int min, int max, int time, boolean bake, boolean canBurn)
	{
	 ...
	 * @param bake whether it needs to be enclosed in an oven
	 */
	public static CookRecipe addRecipe(ItemStack in, ItemStack out, ItemStack burnt, int min, int max, int time, int burntime, boolean bake, boolean canBurn)
	{
