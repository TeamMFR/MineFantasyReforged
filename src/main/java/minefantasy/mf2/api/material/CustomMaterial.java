...
public class CustomMaterial {
	 ...
	 * 
	 * @param name
	 *            The name of the material (and registration)
	 * @param type
	 *            What it is (Metal, Wood, etc)
	 * @param tier
	 *            The tier of the material
	 * @param hardness
	 *            How hard the material is to break
	 * @param flexibility
	 *            How well the material can bend and retract
	 * @param sharpness
	 *            How well it can be sharpened
	 * @param resistance
	 *            How well it can handle destructive elements like fire and
	 *            corrosion, and increased heating temperature
	 * @param density
	 *            how dense the element is, increasing mass per unit. (KG/Units)
	 */
