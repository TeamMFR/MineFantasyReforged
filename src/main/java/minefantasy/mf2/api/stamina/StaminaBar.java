...
public class StaminaBar {
	 ...
	 *            the user
	 * @param value
	 *            the amount to add to max stamina
	 * @param maxBonus
	 *            the maximum this can achieve (not counting base stamina), <0 means
	 *            no limit
	 */
	 ...
	 * 
	 * @param onUse
	 *            whether or not stamina is trying to be used
	 * @return
	 */
