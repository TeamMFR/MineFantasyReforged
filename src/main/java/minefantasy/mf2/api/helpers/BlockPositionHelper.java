...
public class BlockPositionHelper {
	 ...
	 * 
	 * @param clickX
	 *            the area clicked on X (called in blockActivated)
	 * @param clickY
	 *            the area clicked on Y (called in blockActivated)
	 * @param xBound
	 *            the x boundry of the block
	 * @param xBound2
	 *            the x max boundry of the block
	 * @param yBound
	 *            the y boundry of the block
	 * @param yBound2
	 *            the y max boundry of the block
	 * @param xSlots
	 *            the slot count x
	 * @param ySlots
	 *            the slot count y
