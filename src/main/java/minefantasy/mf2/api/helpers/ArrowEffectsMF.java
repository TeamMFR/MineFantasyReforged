...
public class ArrowEffectsMF
{
	...
	/**
	 * Gets the arrow dropped when an enemy is killed.
	 * MODS NEED TO ADD THEIR OWN SUPPORT
	...
	/**
	 * Gets the list of items that arrows have stuck in from the "stickArrowIn" method;
	 * THIS IS ONLY CALLED BY LIVING ENTITIES
