...
public class TacticalManager {
	 ...
	 * @param defender
	 *            the entity on view is questioned
	 * @param angle
	 *            the angle the defender is flanked by
	 ...
	 * 
	 * @param target
	 *            the enemy to be knocked back
	 * @param source
	 *            the source of the knockback
	 * @param power
	 *            the power a - pulls
	 * @param height
	 *            the height they jump
	 */
	 ...
	 * 
	 * @param attacker
	 *            the entity that hit defender
	 * @param defender
	 *            the hit entity in question
	 ...
	 * 
	 * @param attacker
	 *            Who is attacking (can be null)
	 * @param target
	 *            Who is wielding
	 * @param steal
	 *            If the attacker should wield the target's weapon
	 */
