...
public class ArmourCalculator {
	...
	/**
	 * @param considerSpeed
	 *            if true: some pieces will be ignored, ment for speed calculations
	 */
	 ...
	 * 
	 * @param src
	 *            the source (breaks down to ratio)
	 * @param value
	 *            the variable to modify
	 * @param cuttingProt
	 *            the cutting resistence
	 * @param bluntProt
	 *            the blunt resistence
	 * @param pierceProt
	 *            the piercing resistence
	 * @return
	 */
