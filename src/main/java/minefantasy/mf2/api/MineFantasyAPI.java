...
public class MineFantasyAPI {
	 ...
	 *            The output item
	 * @param hot
	 *            True if the result is hot(Does not apply to blocks)
	 * @param experiance
	 *            the experiance gained from crafting
	 * @param toolType
	 *            the tool type required to hit ("hammer", "hvyHammer", etc)
	 * @param hammerType
	 *            the hammer tier required for creation:
	 * @param anvil
	 *            the anvil required bronze 0, iron 1, steel 2
	 * @param forgeTime
	 *            The time taken to forge(default is 200. each hit is about 100)
	 * @param input
	 *            The input for the item (Exactly the same as regular recipes)
	 */
	 ...
	 *            the Skill used
	 * @param result
	 *            what item comes out (basic itemstack)
	 * @param research
	 *            what research is used
	 * @param hot
	 *            whether it requires quenching
	 * @param toolType
	 *            the tool used (hammer or hvyHammer)
	 * @param hammerType
	 *            the tier of hammer
	 * @param anvil
	 *            the tier of anvil
	 * @param forgeTime
	 *            the time it takes to forge
	 * @param input
	 *            the items input
	 * @return
	 */
	 ...
	 * 
	 * @param result
	 *            The output item (basic itemstack)
	 * @param sound
	 *            The sound it makes ("minefantasy2:blocks.carpentermallet"),
	 *            "step.wood", etc
	 * @param experience
	 *            the experience gained from crafting
	 * @param toolType
	 *            the tool type required to hit
	 * @param toolTier
	 *            the tools tier required for creation:
	 * @param craftTime
	 *            The time taken to craft(default is 200. each hit is about 100)
	 * @param input
	 *            The input for the item (Exactly the same as regular recipes)
	 */
	 ...
	 * 
	 * @param dupe
	 *            the amount of times the ratio can be added
	 * @param out
	 *            The result
	 * @param level
	 *            The minimal furnace level
	 ...
	 * 
	 * @param alloy
	 *            the Alloy to add Use this if you want your alloy to have special
	 *            properties
	 * @see Alloy
	 */
	 ...
	 * @param unstable
	 *            when the ingot is unstable(celcius)
	 */
	 ...
	 * 
	 * @param input
	 *            can be an "Item", "Block" or "ItemStack"
	 */
	 ...
	 *            minimal temperature to work
	 * @param max_temperature
	 *            maximum temperature until burn
	 * @param time
	 *            how many ticks until it finishes
	 * @param requireBaking
	 *            whether it needs to be in an oven
	 */
	 ...
	 *            whether it needs to be in an oven
	 * @param canBurn
	 *            false if it cannot burn by traditional means (such as if its in a
	 *            container)
	 */
	public static CookRecipe addCookingRecipe(ItemStack input, ItemStack output, int min_temperature,
	 ...
	 *            how many ticks until it finishes
	 * @param burn_time
	 *            how long until a finished product burns
	 * @param requireBaking
	 *            whether it needs to be in an oven
	 * @param canBurn
	 *            false if it cannot burn by traditional means (such as if its in a
