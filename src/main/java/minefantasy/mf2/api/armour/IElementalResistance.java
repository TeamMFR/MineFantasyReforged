...
public interface IElementalResistance
{
	...
	/**
	 * @return the Magic resistance percent (0-100) (for the whole suit)
	 * -values mean weakness
	 */
	...
	/**
	 * @return the Base resistance percent for non magic/fire(0-100) (for the whole suit)
	 * -values mean weakness
	 */
