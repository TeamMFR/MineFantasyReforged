...
public class CustomArmourEntry {
	 ...
	 *            the ArmourDesign to work off
	 * @param weightMod
	 *            the multiplier for the tier weight if a tier is heavier or lighter
	 */
	 ...
	 *            the bulk of the piece
	 * @param alterSpeed
	 *            if the armour's weight slows you down
	 */
	 ...
	 * 
	 * @param deft
	 *            the default preset if not present
	 */
