...
public class ArmourDesign {
	 ...
	 * 
	 * @param register
	 *            The string that it is registered under (For config)
	 * @param name
	 *            The name of the Design
	 * @param prot
	 *            The protection against basic damage (1.0F = normal protection for
	 *            tier)
	 * @param dura
	 *            The durability modifier
	 * @param weight
	 *            the weight in Kg of the suit
	 * @param bulk
	 *            the bulk of the suit (1.0 = plate, 0.5 = splint, etc)
	 */
