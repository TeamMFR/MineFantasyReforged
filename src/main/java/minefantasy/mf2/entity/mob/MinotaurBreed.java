...
public class MinotaurBreed 
{
	...
	public MinotaurBreed(ArrayList pool, String name, String tex, String weapons, int xp, float health, float poundDamage, float goreDamage, int AR)
	{
		this.pool = pool;
		pool.add(this);
		this.name = name;
