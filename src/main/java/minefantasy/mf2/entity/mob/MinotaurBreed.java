...
public class MinotaurBreed {
	 ...
	 * 
	 * @param threshold
	 *            the percent (0-100) health where it triggers (Default 25%)
	 * @param damage
	 *            (The damage done by melee)
	 * @param grabChance
	 *            the percent (0-100) chance to grab enemies when beserked (Default
	 *            25%)
	 */
	 ...
	 * 
	 * @param grabChance
	 *            the percent (0-100) chance to disarm enemies with a power attack
	 *            (Default 10%)
	 * @param grabChance
	 *            the percent (0-100) chance to grab enemies (Default 10%)
	 * @param grabChance
	 *            the percent (0-100) chance to throw grabbed enemies when hit
	 *            (Default 20%)
	 * @return
	 */
