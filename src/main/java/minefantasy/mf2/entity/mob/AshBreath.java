...
public class AshBreath extends DragonBreath 
{
	...
	{
		return shooter == null ? new DamageSource("ashblastBase").setDamageBypassesArmor() : (new EntityDamageSourceIndirect("ashblast", breath, shooter).setDamageBypassesArmor());
	}
