...
public class FoodListMF
{
	...
	public static Item sandwitch_meat = (new ItemMultiFood("sandwitch_meat",    2,6,  1.0F, false, 0)).setFoodStats(2, 0.0F, 0.5F, 0.5F).setTextureName("minefantasy2:food/sandwitch").setUnlocalizedName("sandwitch");
	public static Item sandwitch_big = (new ItemMultiFood("sandwitch_big",      4,6,  1.0F, false, 1)).setFoodStats(2, 0.0F, 0.5F, 0.5F).setTextureName("minefantasy2:food/sandwitchbig").setUnlocalizedName("sandwitch");
	...
	public static Item pieslice_apple = (new ItemFoodMF("pieslice_apple",      5,  1.0F, false, 0)).setFoodStats(3, 0.8F, 0.2F, 0.0F).setEatTime(16).setAlwaysEdible().setAlwaysEdible().setTextureName("minefantasy2:food/applepie_slice").setMaxStackSize(1);
	public static Item pieslice_berry = (new ItemFoodMF("pieslice_berry",      5 , 1.0F, false, 0)).setFoodStats(3, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setAlwaysEdible().setTextureName("minefantasy2:food/berrypie_slice").setMaxStackSize(1);
	...
	public static Item pieslice_shepards = (new ItemFoodMF("pieslice_shepards",       10, 1.0F, false, 1)).setFoodStats(4, 0.0F, 0.5F, 0.5F).setTextureName("minefantasy2:food/shepardspie_slice").setMaxStackSize(1);
	...
	public static Item eclair_uniced = (new ItemFoodMF("eclair_uniced", 	    5,    1.0F, false, 0)).setFoodStats(5, 0.3F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(64).setTextureName("minefantasy2:food/unfinished/eclair_uniced");
	public static Item eclair_empty = (new ItemFoodMF("eclair_empty", 	        5,    1.0F, false, 0)).setFoodStats(5, 0.5F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(64).setTextureName("minefantasy2:food/unfinished/eclair_empty");
