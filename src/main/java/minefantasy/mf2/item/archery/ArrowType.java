...
public class ArrowType
{
	...
	public static ArrowType	NORMAL		= new ArrowType("normal", 1.00F, 1.00F, 1.00F).setRatio(1F, 3F, 0F);//Some cut, most pierce
	public static ArrowType	BODKIN		= new ArrowType("bodkin", 1.50F, 0.65F, 0.75F).setRatio(0F, 1F, 0F);//Pure piercing
	public static ArrowType	BROADHEAD	= new ArrowType("broad",  0.80F, 1.20F, 1.50F).setRatio(1F, 2F, 0F);//More cutting than normal
