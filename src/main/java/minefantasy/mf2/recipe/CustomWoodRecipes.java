...
public class CustomWoodRecipes 
{
	...
	{
		ItemStack timber = ((ItemComponentMF)ComponentListMF.plank).construct(material.name);
		...
		MineFantasyAPI.addCarpenterRecipe(construction, cutPlank, "", sawing, "saw", material.tier, (int)(material.durability * time) , new Object[]
		{
			"T",
			'T', timber,
		}));
		...
		MineFantasyAPI.addCarpenterRecipe(construction, woodpane, "", nailHammer, "hammer", material.tier, (int)(material.durability * time) , new Object[]
		{
			"NNN",
			"CTC",
			"CTC",
		...
		Salvage.addSalvage(woodpane, cutPlank, cutPlank, cutPlank, cutPlank, timber, timber, new ItemStack(ComponentListMF.nail, 3));
		...
		Salvage.addSalvage(result, cutPlank, cutPlank, cutPlank, timber, timber, timber, timber, new ItemStack(ComponentListMF.nail, 2));
		
		time = 20;
		result = ((BlockWoodDecor)BlockListMF.food_box_basic).construct(material.name);
		KnowledgeListMF.foodboxR.add( 
		MineFantasyAPI.addCarpenterRecipe(construction, result, "food_box", nailHammer, "hammer", material.tier, (int)(material.durability * time) , new Object[]
		{
			"HC ",
			"C C",
			"NCN",
			'N', ComponentListMF.nail,
			'H', ComponentListMF.hinge,
			'C', cutPlank,
		}));
		Salvage.addSalvage(result, cutPlank, cutPlank, cutPlank, cutPlank, new ItemStack(ComponentListMF.nail, 2), ComponentListMF.hinge);
		
		time = 30;
		result = ((BlockWoodDecor)BlockListMF.ammo_box_basic).construct(material.name);
		KnowledgeListMF.ammoboxR.add( 
		MineFantasyAPI.addCarpenterRecipe(construction, result, "ammo_box", nailHammer, "hammer", material.tier, (int)(material.durability * time) , new Object[]
		{
			"HPH",
			"C C",
			"NPN",
		...
		Salvage.addSalvage(result, cutPlank, cutPlank, woodpane, woodpane, new ItemStack(ComponentListMF.nail, 2), new ItemStack(ComponentListMF.hinge, 2));
		
		time = 50;
		result = ((BlockWoodDecor)BlockListMF.crate_basic).construct(material.name);
		KnowledgeListMF.bigboxR.add( 
		MineFantasyAPI.addCarpenterRecipe(construction, result, "big_box", nailHammer, "hammer", material.tier, (int)(material.durability * time) , new Object[]
		{
			"NNNN",
			"HPPH",
			"P  P",
