...
public class RenderPowerArmour extends RendererLivingEntity
{
    ...
    public void doRender(Entity entity, double x, double y, double z, float f, float f1)
    {
    	...
    	this.doRender((EntityLivingBase)user, x, y, z, f, f1);
    }
    ...
    public void doRender(EntityLivingBase entity, double x, double y, double z, float f, float f1)
    {
        ...
        try
        {
            ...
            if(entity instanceof EntityCogwork && entity.riddenByEntity == null && ((EntityCogwork)entity).isUnderRepairFrame())
            {
            ...
            for (int i = 0; i < 4; ++i)
            {
                ...
                if (j > 0)
                {
                    ...
                    if ((j & 15) == 15)
                    {
                        f8 = (float)entity.ticksExisted + f1;
	...
	protected void renderModel(int layer, EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
