...
private void renderDoor(TileEntityBigFurnace tile, int x, int y, int w, int h, int tw, int th) {
...
private void renderDoorHeater(TileEntityBigFurnace tile, int x, int y, int w, int h, int tw, int th) {
	Minecraft mc = Minecraft.getMinecraft();
