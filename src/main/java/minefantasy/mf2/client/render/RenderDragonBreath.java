...
public class RenderDragonBreath extends Render
{
    ...
    public void doRender(Entity entity, double x, double y, double z, float f, float f1)
    {
        ...
        Minecraft.getMinecraft().getTextureManager().bindTexture(TextureHelperMF.getResource(breath.getTextureName() + ".png"));
    ...
    private void renderImg(EntityDragonBreath breath, Tessellator tessellator)
    {
        ...
        tessellator.addVertexWithUV((double)(0.0F - f5), (double)(0.0F - f6), 0.0D, (double)x1, (double)y2);
        tessellator.addVertexWithUV((double)(f4 - f5), (double)(0.0F - f6), 0.0D, (double)x2, (double)y2);
        tessellator.addVertexWithUV((double)(f4 - f5), (double)(f4 - f6), 0.0D, (double)x2, (double)y1);
        tessellator.addVertexWithUV((double)(0.0F - f5), (double)(f4 - f6), 0.0D, (double)x1, (double)y1);
        tessellator.draw();
    }
}