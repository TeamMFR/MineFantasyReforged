...
public abstract class StructureModuleMF {
	 ...
	 *            the block metadata
	 * @param x
	 *            The x offset(relation to xCoord)
	 * @param y
	 *            The y offset(relation to yCoord)
	 * @param z
	 *            The z offset(relation to zCoord)
	 */
	 ...
	 * @param y
	 *            the relative y position to start
	 * @param z
	 *            the relative z position
	 * @param max
	 *            the max depth
	 * @param penetrance
	 *            how many solid blocks can it pass through
	 * @param relative
	 *            whether or not it must be stopped by concecutive blocks.
	 */
