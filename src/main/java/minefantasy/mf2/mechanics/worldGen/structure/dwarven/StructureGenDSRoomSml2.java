...
public class StructureGenDSRoomSml2 extends StructureModuleMF
{
	...
	private void buildHomeFurnishings(int width, int depth, int height) 
	{
		...
		{
			placeBlock(Blocks.stonebrick, StructureGenAncientForge.getRandomMetadata(rand), x, 1, 5);
			placeBlock(Blocks.stonebrick, StructureGenAncientForge.getRandomMetadata(rand), x, 2, 5);
