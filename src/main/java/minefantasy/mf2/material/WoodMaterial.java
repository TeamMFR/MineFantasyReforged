...
public class WoodMaterial extends CustomMaterial {
	 ...
	 * @param tier
	 *            Tier of the material
	 * @param hardness
	 *            The impact it can take (used for reinforcment in BG shields),
	 *            usually an armour rating based value
	 * @param durability
	 *            how many uses / 250
	 * @param flexibility
	 *            The ability to flex and reshape, used in bow power
	 * @param resistance
	 *            Resistance to rot
	 * @param density
	 *            How much a unit (timber plank) weighs in Kg
	 */
