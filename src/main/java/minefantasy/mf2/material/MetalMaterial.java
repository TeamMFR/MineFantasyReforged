...
public class MetalMaterial extends CustomMaterial
{
	...
	public static void init()
	{
		...
		getOrAddMetal("Tungsten",       4, 8.0F,   0.8F, 3.0F,  35F,	4.0F, 		66 , 86 , 65).setCrafterTiers(3).setMeltingPoint(2000).setArmourStats(1.3F, 1.0F, 1.3F);//Better Cutting/Piercing
		getOrAddMetal("BlackSteel",     5, 6.0F,   1.0F, 4.0F,  50F,	3.0F, 		80 , 80 , 80).setCrafterTiers(4).setMeltingPoint(2000).setArmourStats(1.0F, 1.0F, 1.0F);//Standard
		getOrAddMetal("BlueSteel",      6, 7.0F,   1.2F, 5.0F,  65F,	2.0F, 		28,   31, 159).setCrafterTiers(5).setMeltingPoint(2000).setArmourStats(1.0F, 1.2F, 0.8F);//Better Blunt and Resist
		...
		getOrAddMetal("Adamantium",     7, 12.0F,  0.8F, 8.0F,  80F,	3.5F, 		100, 200, 100).setMeltingPoint(2500).setCrafterTiers(6).setRarity(1);
		getOrAddMetal("Mithium",  	    8, 15.0F,  0.8F, 10.0F, 95F,	2.0F, 		60 , 200, 255).setMeltingPoint(2500).setCrafterTiers(7).setRarity(2).setUnbreakable();
		...
		//Alloy
		getOrAddMetal("CompositeAlloy", 4,  4.5F, 10.0F,  1.0F, 2.5F,  75F,	4.0F, 		65, 75 ,65).setMeltingPoint(2500).setRarity(1).setCrafterTiers(3).modifyCraftTime(5.0F);//Powerful All-Rounder
	}
