...
public class MetalMaterial extends CustomMaterial {
	 ...
	 * 
	 * @param name
	 *            The name, and register for the metal
	 * @param tier
	 *            What tier the metal is
	 * @param hardness
	 *            How hard the material is to break
	 * @param flexibility
	 *            How well the metal can bend
	 * @param sharpness
	 *            How well the metal can be sharpened
	 * @param resistance
	 *            The resistance to elements such as fire and corrosion, right now
	 *            its just 0-100 for armour resistance against elements
	 * @param density
	 *            The overall mass (Kg) for an ingot
	 */
