...
public class EntityHorseTransformer {
    ...
    private static void transformGetTotalArmorValue(MethodNode method) {
        ...
        newInstr.add(new TypeInsnNode(Opcodes.INSTANCEOF, "minefantasy/mf2/api/armour/ItemHorseArmorMFBase"));
        ...
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 1));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/item/ItemStack", getItem, "()Lnet/minecraft/item/Item;", false));
        newInstr.add(new TypeInsnNode(Opcodes.CHECKCAST, "minefantasy/mf2/api/armour/ItemHorseArmorMFBase"));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 1));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "minefantasy/mf2/api/armour/ItemHorseArmorMFBase", "getArmorValue", "(Lnet/minecraft/entity/passive/EntityHorse;Lnet/minecraft/item/ItemStack;)I", false));
    ...
    private static void transformSetHorseTexturePaths(MethodNode method) {
        ...
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 4));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "minefantasy/mf2/api/armour/ItemHorseArmorMFBase", "getArmorTexture", "(Lnet/minecraft/entity/passive/EntityHorse;Lnet/minecraft/item/ItemStack;)Ljava/lang/String;", false));
