...
public class ContainerBombBench extends Container
{
    ...
    public ItemStack transferStackInSlot(EntityPlayer user, int clicked)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (TileEntityBombBench.isMatch(itemstack1, "bolt") || TileEntityBombBench.isMatch(itemstack1, "arrow") || TileEntityBombBench.isMatch(itemstack1, "bombcase") || TileEntityBombBench.isMatch(itemstack1, "minecase"))
                {
