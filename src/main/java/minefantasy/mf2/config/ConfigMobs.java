...
public class ConfigMobs extends ConfigurationBaseMF
{
	...
	public static int minotaurHP, minotaurMD, minotaurGD, minotaurBT, minotaurBD, minotaurDC, minotaurGC, minotaurGCB, minotaurTC;
	public static int guardminotaurHP, guardminotaurMD, guardminotaurGD, guardminotaurBT, guardminotaurBD, guardminotaurDC, guardminotaurGC, guardminotaurGCB, guardminotaurTC;
	public static int eliteminotaurHP, eliteminotaurMD, eliteminotaurGD, eliteminotaurBT, eliteminotaurBD, eliteminotaurDC, eliteminotaurGC, eliteminotaurGCB, eliteminotaurTC;
	public static int bossminotaurHP, bossminotaurMD, bossminotaurGD, bossminotaurBT, bossminotaurBD, bossminotaurDC, bossminotaurGC, bossminotaurGCB, bossminotaurTC;
	...
	protected void loadConfig()
	{
		...
		frostminotaurAR =  Integer.parseInt(config.get(MOB_MINOTAUR, 	"5Fa: Frost armour bonus", 50, "Species Bonus").getString());
