...
public class BlockCookingBench extends BlockTileEntity<TileEntityCookingBench> {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public BlockCookingBench(String registryName) {
		super(Material.WOOD);
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityCookingBench();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		TileEntityCookingBench tile = (TileEntityCookingBench) getTile(world, pos);
