...
public class BlockCrossbowBench extends BlockTileEntity<TileEntityCrossbowBench> {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		ResearchBase crossbowResearch = KnowledgeManagerResearch
				.getResearchByKey("minefantasyreforged:crossbows", true);
		if (!ResearchLogic.getResearchCheck(player, crossbowResearch)) {
