...
public class ArmourMaterialMFR {
    /**
    ...
    public ArmourMaterialMFR(String title, int dura, float AC, int enchant, float weight) {
        name = title;
        durability = dura;
        baseAR = AC;
        enchantment = enchant;
    ...
    public ArmourMaterialMFR setMagicResistance(float magic) {
        magicResistanceModifier = magic;
        return this;
    }

    public ArmourMaterialMFR setFireResistance(float fire) {
        fireResistanceModifier = fire;
        return this;
    }

    public ArmourMaterialMFR setMythic(boolean flag) {
        isMythic = flag;
        return this;
    }
}
