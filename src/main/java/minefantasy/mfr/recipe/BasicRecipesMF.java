...
public class BasicRecipesMF {
	...
	public static void init() {
		...
		TanningRecipe.addRecipe(MineFantasyItems.HIDE_SMALL, mat.craftTimeModifier * 2F, -1,
				new ItemStack(Items.LEATHER));
		TanningRecipe.addRecipe(MineFantasyItems.HIDE_MEDIUM, mat.craftTimeModifier * 3F, -1,
				new ItemStack(Items.LEATHER, 3));
		TanningRecipe.addRecipe(MineFantasyItems.HIDE_LARGE, mat.craftTimeModifier * 4F, -1,
				new ItemStack(Items.LEATHER, 5));
		TanningRecipe.addRecipe(Items.LEATHER, mat.craftTimeModifier * 2F, -1, "shears",
				new ItemStack(MineFantasyItems.LEATHER_STRIP, 4));
	}
