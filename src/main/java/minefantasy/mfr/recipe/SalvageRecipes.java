...
public class SalvageRecipes {
	...
	public static void init() {
		...
		Salvage.addSalvage(Items.OAK_DOOR, new ItemStack(Blocks.PLANKS, 3));
		Salvage.addSalvage(Items.SPRUCE_DOOR, new ItemStack(Blocks.PLANKS, 3));
		Salvage.addSalvage(Items.BIRCH_DOOR, new ItemStack(Blocks.PLANKS, 3));
		Salvage.addSalvage(Items.DARK_OAK_DOOR, new ItemStack(Blocks.PLANKS, 3));
		Salvage.addSalvage(Items.JUNGLE_DOOR, new ItemStack(Blocks.PLANKS, 3));
		Salvage.addSalvage(Items.ACACIA_DOOR, new ItemStack(Blocks.PLANKS, 3));
		Salvage.addSalvage(Items.IRON_DOOR, new ItemStack(Items.IRON_INGOT, 2));
		Salvage.addSalvage(Blocks.TRAPDOOR, new ItemStack(Blocks.PLANKS, 2));
		Salvage.addSalvage(Blocks.HOPPER, Blocks.CHEST, new ItemStack(Items.IRON_INGOT, 5));
		Salvage.addSalvage(Items.CAULDRON, new ItemStack(Items.IRON_INGOT, 4));
