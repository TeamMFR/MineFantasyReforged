 ...
 */
@Deprecated
public class CraftingManagerAnvilOld {
	/**
	 * The static instance of this class
	 */
	private static final CraftingManagerAnvilOld instance = new CraftingManagerAnvilOld();
	...
	private CraftingManagerAnvilOld() {
	 ...
	 */
	public static CraftingManagerAnvilOld getInstance() {
		return instance;
	}
	...
	public ItemStack findMatchingRecipe(IAnvil anvil, AnvilCraftMatrix matrix, World world) {
		...
		if (matrixItemStackCount == 2 && stack0.getItem() == stack1.getItem() && stack0.getCount() == 1 && stack1.getCount() == 1
			...
			if (iAnvilRecipe != null) {
				...
				hammer = iAnvilRecipe.getHammerTier();
