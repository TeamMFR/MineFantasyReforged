                    ...
                    for (int oreY = j1; oreY <= i2; ++oreY) {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D) {
                            for (int oreZ = k1; oreZ <= j2; ++oreZ) {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && world.getBlockState(orePos).getBlock().isReplaceableOreGen(world.getBlockState(orePos), world, orePos, (Predicate<IBlockState>) beddingBlock)) {
                                    success = true;
