...
public class StructureGenDSRoomSml2 extends StructureModuleMFR {
    ...
    public void generate() {
        ...
        MineFantasyReborn.LOG.error("Placed DSRoomSml2 at: " + pos);
    }
    ...
    private Block getFloor(int width, int depth, int x, int z) {
        ...
        return MineFantasyBlocks.REFINED_PLANKS;
    }
    ...
    private void buildHomeFurnishings(int width, int depth, int height) {
        ...
        for (int x = width - 1; x >= (width - 4); x--) {
            placeBlock(world, MineFantasyBlocks.REINFORCED_STONE_BRICKS, x, 1, 5);
            placeBlock(world, MineFantasyBlocks.REINFORCED_STONE_BRICKS, x, 2, 5);
