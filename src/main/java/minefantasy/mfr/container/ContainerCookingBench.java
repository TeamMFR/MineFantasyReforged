...
public class ContainerCookingBench extends ContainerBase {
	private final TileEntityCookingBench tile;
	private final boolean isGuiContainer;

	public ContainerCookingBench(TileEntityCookingBench tile) {
		isGuiContainer = false;
		this.tile = tile;
		int width = TileEntityCookingBench.width;
		int height = TileEntityCookingBench.height;
	...
	public ContainerCookingBench(EntityPlayer player, TileEntityCookingBench tile) {
