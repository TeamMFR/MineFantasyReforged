...
/**
 * Instances of this interface act as keys which allow data of any type to be stored in {@link PlayerData} at
 * runtime. This means spells (or anything else, for that matter) may define their own variables to be stored
 * with the player and handle those variables themselves. This prevents {@code PlayerData} from being cluttered
 * with spell-specific fields and allows addon mods to leverage {@code PlayerData} for their own spells or other data,
