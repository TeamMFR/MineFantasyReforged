 ...
 */
public class ItemAxe extends net.minecraft.item.ItemAxe implements IToolMaterial, IClientRegister {
    ...
    public ItemAxe(String name, ToolMaterial material, int rarity) {
    ...
    public ItemAxe setCustom(String s) {
        canRepair = false;
        isCustom = true;
        canRepair = false;
        return this;
    ...
    public ItemAxe setBaseDamage(float baseDamage) {
        this.baseDamage = baseDamage;
        return this;
    }

    public ItemAxe setEfficiencyMod(float efficiencyMod) {
