...
public class TileEntityBombBench extends TileEntityBase implements IBasicMetre {
	...
	public boolean tryCraft(EntityPlayer player, boolean pressUsed) {
		ResearchBase stickyBombResearch = KnowledgeManagerResearch
				.getResearchByKey("minefantasyreforged:sticky_bomb", true);
		boolean sticky = !pressUsed
				&& ResearchLogic.getResearchCheck(player, stickyBombResearch)
