...
public class OrnateStyle {
    ...
    public static ItemPickMF ORNATE_PICK = Utils.nullValue();
    public static ItemAxeMFR ORNATE_AXE = Utils.nullValue();
    public static ItemSpadeMF ORNATE_SPADE = Utils.nullValue();
    public static ItemHoeMF ORNATE_HOE = Utils.nullValue();
    public static ItemHvyPick ORNATE_HVYPICK = Utils.nullValue();
    public static ItemHvyShovel ORNATE_HVYSHOVEL = Utils.nullValue();
    public static ItemHandpick ORNATE_HANDPICK = Utils.nullValue();
    public static ItemTrowMF ORNATE_TROW = Utils.nullValue();
    public static ItemScythe ORNATE_SCYTHE = Utils.nullValue();
    public static ItemMattock ORNATE_MATTOCK = Utils.nullValue();
    public static ItemLumberAxeMFR ORNATE_LUMBER = Utils.nullValue();
    ...
    public static void init() {
        ...
        ORNATE_LUMBER = (ItemLumberAxeMFR) new ItemLumberAxeMFR(design + "_lumber", mat, 0).setCustom(design).setCreativeTab(tab);
