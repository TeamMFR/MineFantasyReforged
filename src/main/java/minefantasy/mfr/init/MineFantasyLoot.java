...
public class MineFantasyLoot {
	...
	public static void load() {
		...
		DWARVEN_ARMOURY = LootTableList.register(new ResourceLocation(MineFantasyReborn.MOD_ID, "dwarven_tables/dwarven_armoury"));
		DWARVEN_FORGE = LootTableList.register(new ResourceLocation(MineFantasyReborn.MOD_ID, "dwarven_tables/dwarven_forge"));
		...
		DWARVEN_AMMO_BOX = LootTableList.register(new ResourceLocation(MineFantasyReborn.MOD_ID, "dwarven_tables/dwarven_ammo_box")); //TODO Fill out this Loot Table
	...
	private static LootPool getInjectPool(String entryName) {
		return new LootPool(new LootEntry[] {getInjectEntry(entryName)}, new LootCondition[0], new RandomValueRange(1), new RandomValueRange(0, 1), MineFantasyReborn.MOD_ID + "_inject_pool");
	}

	private static LootEntryTable getInjectEntry(String name) {
		return new LootEntryTable(new ResourceLocation(MineFantasyReborn.MOD_ID, "inject/" + name), 1, 0, new LootCondition[0], MineFantasyReborn.MOD_ID + "_inject_entry");
	}
