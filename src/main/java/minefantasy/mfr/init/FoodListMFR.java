...
import minefantasy.mfr.item.food.*;
...
public class FoodListMFR {
    ...
    public static Item horse_raw = (new ItemFoodMF("horse_raw", 4, 0.4F, true)).setPotionEffect(new PotionEffect(MobEffects.HUNGER,500,0), 0.5F);
    ...
    public static Item generic_meat_mince_uncooked = (new ItemFoodMF("generic_meat_mince_uncooked", 2, 0.2F, true)).setContainerItem(ComponentListMFR.clay_pot);
    public static Item generic_meat_mince_cooked = (new ItemFoodMF("generic_meat_mince_cooked", 5, 0.5F, true)).setContainerItem(ComponentListMFR.clay_pot);
    public static Item flour = new ItemComponentMFR("flour", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item breadcrumbs = new ItemComponentMFR("breadcrumbs", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item guts = new ItemComponentMFR("guts", 0).setCreativeTab(CreativeTabMFR.tabFood);
    ...
    public static Item cheese_pot = new ItemUnfinishedFood("cheese_pot").setContainerItem(ComponentListMFR.clay_pot);
    ...
    public static Item cheese_roll = (new ItemFoodMF("cheese_roll", 6, 1.0F, false, 0)).setFoodStats(2, 0.0F, 0.4F, 0.6F).setMaxStackSize(1);
    public static Item jerky = (new ItemFoodMF("jerky", 6, 1.0F, true, 0)).setFoodStats(2, 0.0F, 0.0F, 1.0F).setMaxStackSize(8);
    public static Item saussage_raw = (new ItemFoodMF("saussage_raw", 4, 1.0F, true, 0)).setFoodStats(2, 0.0F, 0.1F, 0.6F).setMaxStackSize(16);
    public static Item saussage_cooked = (new ItemFoodMF("saussage_cooked", 8, 1.0F, true, 0)).setFoodStats(2, 0.0F, 0.2F, 0.8F).setMaxStackSize(16);
    public static Item sweetroll_uniced = (new ItemFoodMF("sweetroll_uniced", 5, 1.0F, false, 0)).setFoodStats(2, 0.5F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(64);
    public static Item sweetroll = (new ItemMultiFood("sweetroll", 2, 3, 1.0F, false, 0)).setFoodStats(2, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible();
    public static Item sandwitch_meat = (new ItemMultiFood("sandwitch_meat", 2, 6, 1.0F, false, 0)).setFoodStats(2, 0.0F, 0.5F, 0.5F).setUnlocalizedName("sandwitch");
    public static Item sandwitch_big = (new ItemMultiFood("sandwitch_big", 4, 6, 1.0F, false, 1)).setFoodStats(2, 0.0F, 0.5F, 0.5F);
    // T3 (Quality baking, metal oven)
    // Util: Metal Oven, Prep Block, Steel Tools (Mid Iron Age)
    public static Item meatpie_slice = (new ItemFoodMF("meatpie_slice", 8, 1.0F, false, 0)).setFoodStats(3, 0.0F, 0.2F, 0.8F).setMaxStackSize(1);
    public static Item pieslice_apple = (new ItemFoodMF("pieslice_apple", 5, 1.0F, false, 0)).setFoodStats(3, 0.8F, 0.2F, 0.0F).setEatTime(16).setAlwaysEdible().setAlwaysEdible();
    public static Item pieslice_berry = (new ItemFoodMF("pieslice_berry", 5, 1.0F, false, 0)).setFoodStats(3, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setAlwaysEdible();
    ...
    // Age)
    public static Item pieslice_shepards = (new ItemFoodMF("pieslice_shepards", 10, 1.0F, false, 1)).setFoodStats(4, 0.0F, 0.5F, 0.5F);
    public static Item cake_slice = (new ItemFoodMF("cake_slice", 3, 0.8F, false, 0)).setFoodStats(3, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(1);
    public static Item carrotcake_slice = (new ItemFoodMF("carrotcake_slice", 4, 0.8F, false, 0)).setFoodStats(4, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(1);

    // T5 (Advanced baking, multiple process, temperature regulation, many
    // ingreedients)
    public static Item choccake_slice = (new ItemFoodMF("choccake_slice", 4, 0.8F, false, 0)).setFoodStats(4, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(1);
    // T6 (Perfeted meals, extremely difficylt to create)
    public static Item bfcake_slice = (new ItemFoodMF("bfcake_slice", 6, 1.0F, false, 1)).setFoodStats(5, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(1);
    public static Item eclair_uniced = (new ItemFoodMF("eclair_uniced", 5, 1.0F, false, 0)).setFoodStats(5, 0.3F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(64);
    public static Item eclair_empty = (new ItemFoodMF("eclair_empty", 5, 1.0F, false, 0)).setFoodStats(5, 0.5F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(64);
    public static Item eclair = (new ItemMultiFood("eclair", 4, 4, 1.0F, false, 1)).setFoodStats(5, 1.0F, 0.0F, 0.0F).setEatTime(16).setAlwaysEdible().setMaxStackSize(1);
    // MISC
    public static Item cake_tin = new ItemComponentMFR("cake_tin", 0).setCreativeTab(CreativeTabMFR.tabFood);
    public static Item pie_tray = new ItemComponentMFR("pie_tin", 0).setStoragePlacement("bigplate", "tray").setCreativeTab(CreativeTabMFR.tabFood);
    public static Item icing = new ItemComponentMFR("icing", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item custard = new ItemComponentMFR("custard", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item coca_powder = new ItemComponentMFR("coca_powder", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item chocolate = new ItemComponentMFR("chocolate", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item chocchips = new ItemComponentMFR("chocchips", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    ...
    public static Item salt = new ItemComponentMFR("salt", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item sugarpot = new ItemComponentMFR("sugarpot", 0).setCreativeTab(CreativeTabMFR.tabFood).setContainerItem(ComponentListMFR.clay_pot);
    public static Item bowl_water_salt = new ItemComponentMFR("bowl_water_salt", 0).setCreativeTab(CreativeTabMFR.tabFood);
    ...
    public static Item burnt_pot = new ItemBurntFood("burnt_pot").setContainerItem(ComponentListMFR.clay_pot);
