...
public class CustomToolListMFR {
    ...
    public static ItemHvyPick STANDARD_HVYPICK = Utils.nullValue();
    public static ItemHvyShovel STANDARD_HVYSHOVEL = Utils.nullValue();
    ...
    public static ItemLumberAxeMFR STANDARD_LUMBER = Utils.nullValue();
    ...
    public static void init() {
        ...
        STANDARD_LUMBER = (ItemLumberAxeMFR) new ItemLumberAxeMFR(design + "_lumber", ToolMaterial.IRON, 0).setCustom(design).setCreativeTab(tab);
