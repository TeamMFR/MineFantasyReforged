...
import minefantasy.mfr.gui.GuiBlastHeater;
import minefantasy.mfr.gui.GuiBloomery;
import minefantasy.mfr.gui.GuiBombBench;
import minefantasy.mfr.gui.GuiCarpenterMF;
...
public class NetworkHandler implements IGuiHandler {
	...
	private static final int ANVIL_PACKET = 5;
