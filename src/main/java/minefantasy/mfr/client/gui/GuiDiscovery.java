...
public class GuiDiscovery extends GuiContainer {
    ...
    private void func_146258_c() {
        GL11.glViewport(0, 0, this.instance.displayWidth, this.instance.displayHeight);
        GL11.glMatrixMode(GL11.GL_PROJECTION);
        GL11.glLoadIdentity();
        GL11.glMatrixMode(GL11.GL_MODELVIEW);
        GL11.glLoadIdentity();
        this.field_146260_g = this.instance.displayWidth;
        this.field_146267_h = this.instance.displayHeight;
        ScaledResolution scaledresolution = new ScaledResolution(this.instance, this.instance.displayWidth, this.instance.displayHeight);
    ...
    public void func_146254_a() {
        if (this.field_146266_k != null && this.field_146263_l != 0L && Minecraft.getMinecraft().player != null) {
            ...
            this.instance.getTextureManager().bindTexture(field_146261_a);
            GL11.glDisable(GL11.GL_LIGHTING);
            this.drawTexturedModalRect(i, j, 96, 202, 160, 32);

            if (this.field_146262_n) {
                this.instance.fontRenderer.drawSplitString(this.field_146265_j, i + 30, j + 7, 120, -1);
            } else {
                this.instance.fontRenderer.drawString(this.field_146268_i, i + 30, j + 7, -256);
                this.instance.fontRenderer.drawString(this.field_146265_j, i + 30, j + 18, -1);
            }
            ...
            this.field_146264_m.renderItemAndEffectIntoGUI(this.instance.fontRenderer, this.instance.getTextureManager(), this.field_146266_k.theItemStack, i + 8, j + 8);
            GL11.glDisable(GL11.GL_LIGHTING);
