...
public class RenderMinotaur extends RenderBiped {
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        if (entity instanceof EntityMinotaur) {
            return TextureHelperMFR.getResource("textures/models/monster/minotaur/" + ((EntityMinotaur) entity).getTexture() + ".png");
        }
        return TextureHelperMFR.getResource("textures/models/monster/minotaur/minotaurBrown.png");
    }
    ...
    protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
        ...
        ItemStack itemstack = p_77029_1_.getHeldItem(EnumHand.MAIN_HAND);
