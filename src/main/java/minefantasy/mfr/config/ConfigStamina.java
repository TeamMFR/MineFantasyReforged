...
public class ConfigStamina extends ConfigurationBaseMF {
	...
	protected void loadConfig() {
		...
		dodgeForceModifier = Float.parseFloat(
				config.get(VALUES, "Dodge Force Modifier", 1.0F,
		...
		dodgeCostModifier = Float.parseFloat(
				config.get(VALUES, "Dodge Stamina Cost Modifier", 1.0F,
		...
		dodgeShieldCost = Integer.parseInt(
				config.get(VALUES, "Dodge Shield Stamina cost", 100, "Modify how much dodging with a shield costs in stamina points.").getString());
