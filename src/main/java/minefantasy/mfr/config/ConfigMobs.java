...
public class ConfigMobs extends ConfigurationBaseMF {
	...
	protected void loadConfig() {
		shouldFireCausePanic = Boolean.parseBoolean(config.get(GENERAL, "Should Fire Cause Panic", false,
				"Should a mob being caught on fire cause 'panic' AKA jumping around flailing their arms around").getString());

		youngdragonHP = Integer.parseInt(config.get(MOB_DRAGON, "2Aa: Health", 60,
		...
		dragonHP = Integer.parseInt(config.get(MOB_DRAGON, "2Ba: Health", 100,
		...
		diredragonHP = Integer.parseInt(config.get(MOB_DRAGON, "2Ca: Health", 200,
		...
		elderdragonHP = Integer.parseInt(config.get(MOB_DRAGON, "2Da: Health", 500,
		...
		ancientdragonHP = Integer.parseInt(config.get(MOB_DRAGON, "2Ea: Health", 1000,
		...
		dragonGriefFire = Boolean.parseBoolean(
				config.get(MOB_DRAGON, "4B: Fire Grief", true,
		...
		dragonMSG = Boolean.parseBoolean(config.get(MOB_DRAGON, "4D: Spawn Message", true,
		...
		EntityDragon.heartChance = Float.parseFloat(config.get(MOB_DRAGON, "4F: Heart Drop chance modifier", 1F,
		...
		minotaurHP = Integer.parseInt(config.get(MOB_MINOTAUR, "5Ba: Health", 30,
		...
		minotaurDC = Integer.parseInt(config.get(MOB_MINOTAUR, "5Bf: Disarm chance when mob power attacks", 10).getString());
		...
		guardminotaurHP = Integer.parseInt(config.get(MOB_MINOTAUR, "5Ca: Health", 30,
		...
		guardminotaurBT = Integer.parseInt(config.get(MOB_MINOTAUR, "5Ce: Beserk threshold (% health)", 35).getString());
		guardminotaurDC = Integer.parseInt(config.get(MOB_MINOTAUR, "5Cf: Disarm chance when mob power attacks", 10).getString());
		...
		eliteminotaurHP = Integer.parseInt(config.get(MOB_MINOTAUR, "5Da: Health", 50,
		...
		eliteminotaurBT = Integer.parseInt(config.get(MOB_MINOTAUR, "5De: Beserk threshold (% health)", 40).getString());
		eliteminotaurDC = Integer.parseInt(config.get(MOB_MINOTAUR, "5Df: Disarm chance when mob power attacks", 20).getString());
		...
		bossminotaurHP = Integer.parseInt(config.get(MOB_MINOTAUR, "5Ea: Health", 60,
		...
		bossminotaurDC = Integer.parseInt(config.get(MOB_MINOTAUR, "5Ef: Disarm chance when mob power attacks", 40).getString());
		...
		frostminotaurAR = Integer.parseInt(config.get(MOB_MINOTAUR, "5Fa: Frost armour bonus", 50,
