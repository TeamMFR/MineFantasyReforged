...
public class BasicTierRecipe extends ShapedRecipes {
    ...
    public BasicTierRecipe(String group, int width, int height, NonNullList<Ingredient> input, ItemStack output) {
    ...
    public static BasicTierRecipe add(ItemStack result, Object... input) {
        ...
        BasicTierRecipe recipe = new BasicTierRecipe(var3, var5, var6, var15, result);
        GameRegistry.addShapedRecipe(recipe);
        return recipe;
    }
