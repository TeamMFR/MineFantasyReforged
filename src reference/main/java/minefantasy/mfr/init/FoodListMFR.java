...
public class FoodListMFR {
    ...
    public static Item generic_meat_mince_cooked = (new ItemFoodMF("generic_meat_mince_cooked", 5, 0.5F, true))
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item flour = new ItemComponentMFR("flour", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item breadcrumbs = new ItemComponentMFR("breadcrumbs", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    ...
    public static Item pie_tray = new ItemComponentMFR("pie_tin", 0).setStoragePlacement("bigplate", "tray")
            .setCreativeTab(CreativeTabMFR.tabFood);
    public static Item icing = new ItemComponentMFR("icing", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item custard = new ItemComponentMFR("custard", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item coca_powder = new ItemComponentMFR("coca_powder", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item chocolate = new ItemComponentMFR("chocolate", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item chocchips = new ItemComponentMFR("chocchips", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    ...
    public static Item salt = new ItemComponentMFR("salt", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item sugarpot = new ItemComponentMFR("sugarpot", 0).setCreativeTab(CreativeTabMFR.tabFood)
            .setContainerItem(ComponentListMFR.clay_pot);
    public static Item bowl_water_salt = new ItemComponentMFR("bowl_water_salt", 0)
            .setCreativeTab(CreativeTabMFR.tabFood);
