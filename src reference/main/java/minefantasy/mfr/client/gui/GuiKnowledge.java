...
public class GuiKnowledge extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        ...
        if (p_146284_1_.id == 3 && selected != null) {
            ((EntityPlayerMP) player).sendQueue
        ...
        if (selected == null && achievement != null) {
            ...
            if (!ResearchLogic.canUnlockInfo(player, achievement)) {
                ...
                if (researchVisibility == 3) {
                    ...
                    s = (new TextComponentString("achievement.requires" + new Object[]{achievement.parentInfo.getDisplayName()})).getUnformattedText();
                    k4 = this.fontRenderer.splitStringWidth(s, j4);
                ...
                j4 = Math.max(this.fontRenderer.getStringWidth(s1), 120);
                int k5 = this.fontRenderer.splitStringWidth(s2, j4);
                ...
                if (ResearchLogic.hasInfoUnlocked(player, achievement)) {
                    ...
                    this.fontRenderer.drawStringWithShadow(net.minecraft.util.text.translation.I18n.translateToLocal("information.buy"), i5,
                            j5 + k5 + 4, -7302913);
                }
            }
    ...
    private void renderPurchaseScreen(int x, int y, int mx, int my) {
        if (selected != null) {
            ...
            if (hasScroll) {
                mc.fontRenderer.drawStringWithShadow(net.minecraft.util.text.translation.I18n.translateToLocal("knowledge.hasScroll"), x + 20,
                        y + 32, red);
            } else {
